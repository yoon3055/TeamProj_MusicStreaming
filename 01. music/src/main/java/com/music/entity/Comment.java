...
@Table(name = "song_comment") // 'Comment'는 일반적인 단어이므로 테이블 이름을 'song_comment'로 명시
public class Comment {
    ...
    private String content; // 댓글 내용 (긴 텍스트)
    ...
    public Comment(User user, Song song, String content, LocalDateTime createdAt) {
        this.user = user;
        this.song = song;
