...
import SidebarMiniCard from './SidebarMiniCard'; // SidebarMiniCard 컴포넌트 사용
...
const UserPlaylistsSidebar = ({ onPlay }) => { // onPlay는 SidebarContent로부터 전달받음
...
UserPlaylistsSidebar.propTypes = {
