...
public class InteractionController {
    ...
    public ResponseEntity<List<CommentDto.SongCommentResponse>> getComments(@PathVariable("songId") Long songId) {
    ...
    public ResponseEntity<List<LikeDto.SimpleResponse>> getLikes(@PathVariable("songId") Long songId) {
    ...
    @GetMapping("/api/songs/{songId}/likes/total")
    public ResponseEntity<Long> countLikesBySong(@PathVariable("songId") Long songId) {
    ...
    public ResponseEntity<Long> countLikesByArtist(@PathVariable("artistId") Long artistId) {
