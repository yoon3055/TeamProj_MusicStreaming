...
import com.music.user.dto.MailDto;
...
public class MailService {
    ...
    private static final String title = "[Fruitify] 임시 비밀번호 안내 메일";
    private static final String message = "안녕하세요. Fruitify 임시 비밀번호 안내 메일입니다. "
